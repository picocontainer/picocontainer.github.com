...
p. The StartableLifecycleStrategy can be extended if you prefer your own interface for Startable. Just override
...
p. If you have other synonyms for start/stop/dispose, just extend the ReflectionLifecycleStrategy class and provide them.
...
p. These annotations are supplied with Java 6, but come in a jar for Java 5 and below. See "http://mvnrepository.com/artifact/javax.annotation/jsr250-api":http://mvnrepository.com/artifact/javax.annotation/jsr250-api 
