Project Goalsp. PicoContainer's core was designed with some goals in mind:
...
p. If someone has a need for PicoContainer that we did not originally envision, or a feature not yet imlemented, we will try to accomodate it.
...
Meanwhile, we want teams to be able to use PicoContainer in their project in an inobstrsuve way.We're happy for teams to embed it in such a way that its invisible.p. 
