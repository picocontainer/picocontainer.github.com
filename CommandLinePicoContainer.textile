...
p. CommandLineArgumentsPicoContainer is a special type of PicoContainer that processes the arguments passed into from the command line, and sets them up as configuration for other components.
...
p. For automatic binding of command line arguments to parameter names of the component:
