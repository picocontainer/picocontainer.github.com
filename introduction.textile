...
p. (i) "MutablePicoContainer API ^ !/images/icons/linkext7.gif! ^ ":http://www.picocontainer.org/picocontainer/latest/picocontainer/apidocs/org/picocontainer/MutablePicoContainer.html 
...
p. (Note that this code suffers from the anti-pattern "Propagating Dependency":propagating-dependency-antipattern.html but let's not worry about that for now !/images/icons/emoticons/smile.gif! )
